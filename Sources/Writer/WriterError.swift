...
///
/// ``WriterError`` describes problems which occur through the lifecycle of making a request to the API, from constructing the underlying network request, through making the network request and handling the resulting response.
///
/// Most of the error values have associated failure reasons:
/// - ``WriterError/failedToConstructRequestURL(_:)``
/// - ``WriterError/failedToSerializeRequestParameters(_:)``
/// - ``WriterError/failedToConstructRequest(_:)``
/// - ``WriterError/failedToHandleResponse(_:)``
///
/// which provide more information about why the error occurred.
///
/// If a network error occurs when making an API request, ``WriterError/failedToMakeNetworkRequest(error:)`` has an associated [`Error`](https://developer.apple.com/documentation/swift/error) value which describes more information about why the network error occurred.
///
/// In exceptional circumstances there may be an internal error which occurs in the implementation of ``Writer`` or in the underlying system frameworks. Where this occurs, ``WriterError/internalError(error:)`` provides this information, with additional context if it is available.
///
/// ### Getting an error description
///
/// ``WriterError`` conforms to the [`LocalizedError`](https://developer.apple.com/documentation/foundation/localizederror) protocol. As such a readable description of the error is provided through the [`errorDescription`](https://developer.apple.com/documentation/foundation/localizederror/2946895-errordescription) property.
///
/// ## Topics
///
/// ### Errors
...
/// - ``WriterError/failedToSerializeRequestParameters(_:)``
/// - ``WriterError/failedToConstructRequest(_:)``
/// - ``WriterError/failedToMakeNetworkRequest(error:)``
/// - ``WriterError/failedToHandleResponse(_:)``
/// - ``WriterError/internalError(error:)``
///
/// ### Error failure information
/// - ``WriterError/RequestURLConstructionFailureReason``
/// - ``WriterError/ParameterSerializationFailureReason``
/// - ``WriterError/RequestConstructionFailureReason``
/// - ``WriterError/ResponseHandlingFailureReason``
///
/// ### Convenience properties
/// - ``WriterError/underlyingError``
public enum WriterError: Swift.Error {
    /// Failure reasons for ``WriterError/failedToConstructRequestURL(_:)`` errors
    ...
    /// Failure reasons for ``WriterError/failedToSerializeRequestParameters(_:)`` errors
    ...
    /// Failure reasons for ``WriterError/failedToConstructRequest(_:)`` errors
    ...
    /// Failure reasons for ``WriterError/failedToHandleResponse(_:)`` errors
...
extension WriterError.RequestURLConstructionFailureReason {
...
extension WriterError.ParameterSerializationFailureReason {
    public var localizedDescription: String {
        switch self {
...
extension WriterError.RequestConstructionFailureReason {
    public var localizedDescription: String {
        switch self {
        case .missingRequiredRequestBody:
...
extension WriterError.ResponseHandlingFailureReason {
    public var localizedDescription: String {
        switch self {
        case .failedToDeserializeJSON(let error):
