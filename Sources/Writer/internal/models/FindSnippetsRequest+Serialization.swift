...
extension Operations.FindSnippetsRequest: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        ...
        case .header, .multipart, .form:
            throw SerializationError.invalidSerializationParameter(type: "Operations.FindSnippetsRequest", format: format.formatDescription)
        }
    }
...
extension Operations.FindSnippetsRequest: PathParameterSerializable {
...
extension Operations.FindSnippetsRequest: QueryParameterSerializable {
    func serializedQueryParameters(with parameterDefaults: ParameterDefaults?, formatOverride: SerializableFormat?) throws -> [QueryParameter] {
        ...
        try builder.addQueryParameters(from: shortcuts, named: "shortcuts", format: formatOverride ?? .query(style: .form, explode: true), parameterDefaults: parameterDefaults)
